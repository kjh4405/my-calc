...
if lang == "Korean":
    ...
    t = {
        ...
        "m1": "总组织人数", "m2": "初始费用", "m3": "每月支出", "m4": "总注册奖金", "m5": "每月年金收益", "m6": "每月净利润",
    ...
    t = {
        ...
        "my_p": "ระดับแพ็คเกจของฉัน", "my_gc": "จำนวนเกมต่อเดือน (หน่วย 120)", "pa_p": "ระดับแพ็คเกจคู่ค้า", "l1": "จำนวนผู้แนะนำตรง (รุ่นที่ 1)", "dup": "อัตราการทำซ้ำ (รุ่นที่ 2-6)",
        "m1": "จำนวนคนรวม", "m2": "ต้นทุนเริ่มต้น", "m3": "ค่าใช้จ่ายรายเดือน", "m4": "โบนัสการสมัครรวม", "m5": "รายได้ต่อเนื่องรายเดือน", "m6": "กำไรสุทธิต่อเดือน",
    ...
    t = {
        ...
        "my_p": "Cấp gói của tôi", "my_gc": "Số lượt chơi hàng tháng (Đơn vị 120)", "pa_p": "Cấp gói đối tác", "l1": "Số người giới thiệu trực tiếp (F1)", "dup": "Tỷ lệ sao chép (F2-F6)",
        "m1": "Tổng số thành viên", "m2": "Chi phí ban đầu", "m3": "Chi phí hàng tháng", "m4": "Tổng thưởng đăng ký", "m5": "Thu nhập thụ động hàng tháng", "m6": "Lợi nhuận ròng hàng tháng",
        "tab1": "📊 Chi tiết tiền thưởng", "tab2": "💰 Dự báo ADIL", "tab3": "💳 Chi tiết chi phí",
        "detail_h": "Báo cáo chi tiết tiền thưởng", "item": "Hạng mục", "reg_s": "Thưởng đăng ký (1 lần)", "mon_s": "Thưởng hàng tháng",
