...
# --- 2. 6개 국어 사전 (일본어 번역 고정 및 신규 문구 추가) ---
...
t_all = {
    "Korean": {
        ...
        "ref_title": "ℹ️ 참고용 비용 안내", "ref_init": "🔹 초기 등록 비용", "ref_month": "🔹 월간 예상 유지 비용",
        "ref_init_sub": "(패키지 가격 + 가입비 $60 포함)", "ref_low_sub": "(구독료 $72 + 72 CV 유지를 위한 부족분 보충 비용 포함)",
        "ref_low_tip": "등급은 120게임 플레이와 $72 지불로 72 CV를 유지하는 구조입니다.",
        "ref_high_sub": "(120게임 플레이로 72 CV 자동 충당)",
        "ref_high_tip": "등급은 높은 적립률로 인해 120게임 플레이만으로 유지 조건이 충족됩니다."
    },
    "English": {
        ...
        "ref_title": "ℹ️ Reference Cost Info", "ref_init": "🔹 Initial Registration Cost", "ref_month": "🔹 Est. Monthly Maintenance",
        "ref_init_sub": "(Includes Pkg + $60 fee)", "ref_low_sub": "($72 Sub + extra cost for 72 CV maintenance)",
        "ref_low_tip": "tier maintains 72 CV with 120 games and $72 payment.",
        "ref_high_sub": "(72 CV auto-covered by 120 games)",
        "ref_high_tip": "tier satisfies maintenance with 120 games due to high accumulation rate."
    },
    "Japanese": {
        ...
        "ref_title": "ℹ️ 参考用費用案内", "ref_init": "🔹 初期登録費用", "ref_month": "🔹 月間予想維持費",
        "ref_init_sub": "(パッケージ価格 + 加入費 $60 含む)", "ref_low_sub": "(購読料 $72 + 72 CV維持のための不足分補充費用含む)",
        "ref_low_tip": "評価は120ゲームプレイと$72の支払いで72 CVを維持する構造です。",
        "ref_high_sub": "(120ゲームプレイで72 CV自動充当)",
        "ref_high_tip": "評価は高い積立率により120ゲームプレイだけで維持条件が充足されます。"
    },
    "Chinese": {"unit": "人", "title": "📊 DHP & ADIL 综合资产分析", "sidebar_h": "📌 设置", "my_p": "我的等级", "my_gc": "每月游戏次数", "pa_p": "伙伴等级", "l1": "直接推荐", "dup": "复制", "m1": "总组织", "m2": "总注册奖", "m3": "总月度奖", "m4": "每月 ADIL", "tab1": "👥 多层次", "tab2": "⚖️ 双轨制", "tab3": "🚀 轨道", "tab4": "🪙 ADIL 估值", "tab5": "💸 现金流", "exp_init": "初始投资", "exp_month": "每月支出", "net_profit": "每月净利润", "col_gen": "代", "col_people": "人数", "col_reg": "注册($)", "col_mon": "月度($)", "matching_cv": "Matching CV", "bonus_usd": "奖金($)", "cycle": "循环", "adil_info": "120场游戏中获得7.5场第1名 (价值$30的ADIL / $0.4时为562.5个)", "ref_title": "ℹ️ 参考费用信息", "ref_init": "🔹 初始注册费用", "ref_month": "🔹 预计每月维持费", "ref_init_sub": "(含套餐 + $60 注册费)", "ref_low_sub": "(含 $72 订阅费 + 维持 72 CV 的额外费用)", "ref_low_tip": "等级通过 120 场游戏和支付 $72 来维持 72 CV。", "ref_high_sub": "(120 场游戏自动覆盖 72 CV)", "ref_high_tip": "等级因高积攒率，仅需 120 场游戏即可满足维持条件。"},
    "Thai": {"unit": "คน", "title": "📊 วิเคราะห์ DHP & ADIL ทั้งหมด", "sidebar_h": "📌 ตั้งค่า", "my_p": "ระดับของฉัน", "my_gc": "เกมต่อเดือน", "pa_p": "ระดับพาร์ทเนอร์", "l1": "แนะนำตรง", "dup": "การทำซ้ำ", "m1": "คนรวม", "m2": "โบนัสสมัคร", "m3": "โบนัสรายเดือน", "m4": "ADIL ต่อเดือน", "tab1": "👥 ยูนิเลเวล", "tab2": "⚖️ ไบนารี", "tab3": "🚀 ออร์บิท", "tab4": "🪙 ประเมิน ADIL", "tab5": "💸 วิเคราะห์จ่าย", "exp_init": "เงินลงทุน", "exp_month": "รายจ่ายเดือน", "net_profit": "กำไรสุทธิ", "col_gen": "รุ่น", "col_people": "คน", "col_reg": "สมัคร($)", "col_mon": "รายเดือน($)", "matching_cv": "Matching CV", "bonus_usd": "โบนัส($)", "cycle": "รอบ", "adil_info": "ได้ที่ 1 ใน 7.5 จาก 120 เกม (รับ ADIL มูลค่า $30 / 562.5 ADIL ที่ $0.4)", "ref_title": "ℹ️ ข้อมูลค่าใช้จ่ายอ้างอิง", "ref_init": "🔹 ค่าลงทะเบียนเริ่มต้น", "ref_month": "🔹 ประมาณการค่าบำรุงรายเดือน", "ref_init_sub": "(รวมแพ็คเกจ + ค่าธรรมเนียม $60)", "ref_low_sub": "(รวมค่าสมัคร $72 + ค่าธรรมเนียมเพิ่มเติมสำหรับ 72 CV)", "ref_low_tip": "ระดับนี้รักษา 72 CV ด้วยการเล่น 120 เกมและชำระ $72", "ref_high_sub": "(72 CV ครอบคลุมอัตโนมัติจากการเล่น 120 เกม)", "ref_high_tip": "ระดับนี้ผ่านเงื่อนไขการบำรุงรักษาด้วยการเล่น 120 เกมเนื่องจากอัตราสะสมสูง"},
    "Vietnamese": {"unit": "Người", "title": "📊 Phân tích DHP & ADIL tổng thể", "sidebar_h": "📌 Cài đặt", "my_p": "Cấp của tôi", "my_gc": "Lượt chơi/tháng", "pa_p": "Cấp đối tác", "l1": "Trực tiếp", "dup": "Sao chép", "m1": "Tổng tổ chức", "m2": "Thưởng ĐK", "m3": "Thưởng tháng", "m4": "ADIL tháng", "tab1": "👥 Unilevel", "tab2": "⚖️ Binary", "tab3": "🚀 ORBIT", "tab4": "🪙 Định giá ADIL", "tab5": "💸 Dòng tiền", "exp_init": "Vốn ban đầu", "exp_month": "Chi phí tháng", "net_profit": "Lợi nhuận ròng", "col_gen": "Thế hệ", "col_people": "Số người", "col_reg": "Thưởng ĐK", "col_mon": "Thưởng tháng", "matching_cv": "Matching CV", "bonus_usd": "Thưởng($)", "cycle": "Chu kỳ", "adil_info": "Đạt giải nhất 7.5 trong 120 trận (Nhận $30 ADIL / 562.5 ADIL tại $0.4)", "ref_title": "ℹ️ Thông tin chi phí tham khảo", "ref_init": "🔹 Chi phí đăng ký ban đầu", "ref_month": "🔹 Chi phí duy trì hàng tháng", "ref_init_sub": "(Bao gồm gói + phí $60)", "ref_low_sub": "(Bao gồm $72 phí thuê bao + chi phí bổ sung cho 72 CV)", "ref_low_tip": "Cấp này duy trì 72 CV bằng cách chơi 120 trận và thanh toán $72.", "ref_high_sub": "(Tự động bù 72 CV khi chơi 120 trận)", "ref_high_tip": "Cấp này đáp ứng điều kiện duy trì chỉ với 120 trận chơi nhờ tỷ lệ tích lũy cao."}
}
...
base_sub = (my_gc / 120) * 72.0 
my_earned_cv = my_gc * 20 * pkgs[my_p]["self_rate"]
cv_short = max(0.0, 72.0 - my_earned_cv)
extra_maintenance = cv_short * 2.0 if my_p in ["Basic", "Standard"] else 0.0
month_exp = base_sub + extra_maintenance
...
with st.expander(t["ref_title"]):
    ...
    with col_info1:
        st.write(f"**{t['ref_init']}:** `${pkgs[my_p]['price'] + 60:,.1f}`")
        st.caption(t["ref_init_sub"])
    with col_info2:
        st.write(f"**{t['ref_month']}:** `${month_exp:,.1f}`")
        if my_p in ["Basic", "Standard"]:
            st.caption(t["ref_low_sub"])
            st.info(f"💡 {my_p} {t['ref_low_tip']}")
        else:
            st.caption(t["ref_high_sub"])
            st.success(f"✨ {my_p} {t['ref_high_tip']}")
...
with tab5:
    ...
    with c2: st.success(f"**💰 {t['net_profit']}: ${net_profit:,.1f}**")
